...
export class MatchesService {
  ...
  async findOne(id: number) {
    ...
    if (!match) throw new NotFoundException(`ID ${id} bo‘lgan match topilmadi`);
    return { success: true, message: "Match topildi", data: match };
  }
